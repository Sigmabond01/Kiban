  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden font-noto">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center h-full text-center font-bold px-4">
          <h1 className="text-9xl text-gray-800 mb-4 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-950 via-gray-800 to-slate-800 bg-clip-text text-transparent">KIBAN</h1>
