    ...
    const loadProgress = async () => {
      ...
      if(isAuthenticated && token) {
        try {
          ...
          const response = await axios.get(`${API_URL}/N5/Vocabulary`, config);
          ...
          console.error("Error fetching N5 Vocabulary progress: ", error);
        ...
        >
          ...
          <div className="flex items-center space-x-2 sm:space-x-6">
            <div className="w-24 sm:w-64 bg-gray-700/50 rounded-full h-2 sm:h-3 overflow-hidden border border-gray-600/50">
              <div 
                className="bg-gradient-to-r from-orange-500 to-red-500 h-full rounded-full transition-all duration-300 ease-out shadow-lg" 
          ...
          <div className="mt-6 sm:mt-8 animate-in slide-in-from-top-2 duration-300">
            ...
            <div className="space-y-2">
              {problems.map((problem, index) => (
                <div 
                  key={problem.id} 
                  className="border border-gray-700/30 rounded-lg hover:border-gray-600/50 hover:bg-gray-800/10 transition-all duration-300 group"
                  style={{
                  ...
                  <div className="hidden sm:grid grid-cols-12 gap-4 py-4 px-6 items-center">
                    ...
                    <div className="col-span-2 flex justify-center">
                      <a 
                        ...
                        className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/30 hover:border-blue-400 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-blue-500/25 group/doc"
                      >
