...
const Register = () => {
    const { register, loading } = useAuth(null);
    ...
    return (
        <div className="flex items-center justify-center font-noto min-h-screen bg-[url('/src/assets/background1.webp')] bg-cover bg-center">
